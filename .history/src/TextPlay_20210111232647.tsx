...
export class TextPlay extends Component<{}, TextState> {
    tick() {
        ...
        textMap.set("אחד שתיים Ipsum is simply dummy text of the", 1);
    ...
    createTextDivs(): React.ReactNode  {
        ...
        for(var string of keys) {
            const value = this.state.text.get(string) || this.state.defaultState;
            values.push(<div className="textBlock" onMouseEnter={() => this.setState({ textState: value }) }>
            {
